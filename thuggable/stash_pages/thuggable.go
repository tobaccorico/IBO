...
func (u *ThuggableScreen) refreshSharesDisplay() {
...
func NewThuggableScreen(window fyne.Window, app fyne.App) fyne.CanvasObject {
	u := &ThuggableScreen{
	...
	u.container = container.NewVBox(
		widget.NewLabel("Thuggable MPC Setup"),
		thresholdPartyForm,
		initButton,
		sessionIDForm,
		joinButton,
...
func (u *ThuggableScreen) initializeSession() {
...
func (u *ThuggableScreen) joinSession() {
...
func (u *ThuggableScreen) appendLog(message string) {
...
func (u *ThuggableScreen) Move(position fyne.Position) {
	u.container.Move(position)
}

func (u *ThuggableScreen) Resize(size fyne.Size) {
	u.container.Resize(size)
}

func (u *ThuggableScreen) Position() fyne.Position {
	return u.container.Position()
}

func (u *ThuggableScreen) Size() fyne.Size {
	return u.container.Size()
}

func (u *ThuggableScreen) MinSize() fyne.Size {
	return u.container.MinSize()
}

func (u *ThuggableScreen) Visible() bool {
	return u.container.Visible()
}

func (u *ThuggableScreen) Show() {
	u.container.Show()
}

func (u *ThuggableScreen) Hide() {
	u.container.Hide()
}

func (u *ThuggableScreen) Refresh() {
	u.container.Refresh()
}
