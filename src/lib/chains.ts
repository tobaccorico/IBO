...
export const CHAINS: Record<number, Chain> = {
  1: { id: 1, name: 'Ethereum', icon: '⟠', hex: '0x1', explorer: 'https://etherscan.io', color: '#627EEA', enabled: true, hasLeverage: true },
  137: { id: 137, name: 'Polygon', icon: '🟣', hex: '0x89', explorer: 'https://polygonscan.com', color: '#8247E5', enabled: false, hasLeverage: true },
  8453: { id: 8453, name: 'Base', icon: '🔵', hex: '0x2105', explorer: 'https://basescan.org', color: '#0052FF', enabled: true, hasLeverage: true },
  42161: { id: 42161, name: 'Arbitrum', icon: '🔷', hex: '0xa4b1', explorer: 'https://arbiscan.io', color: '#28A0F0', enabled: true, hasLeverage: true },
  130: { id: 130, name: 'Unichain', icon: '🦄', hex: '0x82', explorer: 'https://uniscan.xyz', color: '#FF007A', enabled: true, hasLeverage: false },
}
...
export const CONTRACTS: Record<number, Contracts> = {
  1: { // Ethereum L1 - ENABLED
    vogue: '0x9d78E7E7dA878a695cde857a053ff94e9512B338',
    vogueCore: '0xDC78D4f52a4460e9de1458C43f3DCb390f7aC71C',
    rover: '0xa950338Ce0a0BfC3e44F5C730C641738E052E19e',
    aux: '0x538CfA4b89Ba97707DAA69693578a06fDE9868C1',
    basket: '0xD13Df5d7790A698b2a06eF1fd81636B7201e30Ad',
  ...
  42161: { // Arbitrum - ENABLED
    ...
    vogueCore: '0x2eA8Ef6585f544Bc57e149Ac4EC09854aEf00c71',
    rover: '0x6647e04E73Ce80235BeBc59Ab7E4AACbCCd23645',
    aux: '0xBb7BB6C91BDeA9502f2591B4AA71dBa3A70FF851',
    basket: '0x6C860c9128a27c394A1833f07b7eCe65019B5709',
    weth: '0x82aF49447D8a07e3bd95BD0d56f35241523fBab1',
  },
  130: { // Unichain - ENABLED (no leverage/Amp)
