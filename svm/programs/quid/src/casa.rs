...
// tickers are not super necessary
// strictly speaking, but could be  
// used to tag the thematic subject 
// matter, your stock vs my stock... 
pub fn stake_battle<'info>(
    depositor: &Account<'info, Depositor>,
    depository: &Account<'info, Depository>,
    battle: &mut Account<Battle>,
    stake_amount: u64, ticker: [u8; 8],
    is_challenger: bool,
) -> Result<()> {
